function varargout = gui_optionsPeakMeasurement(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_optionsPeakMeasurement_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_optionsPeakMeasurement_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%-------------------------------------------------------------------------------------------------------
function gui_optionsPeakMeasurement_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = [];
%values
try
        def  = varargin{1};
...
% UIWAIT makes gui_optionsPeakMeasurement wait for user response (see UIRESUME)
uiwait(handles.gui_chassis);

%-------------------------------------------------------------------------------------------------------
function varargout = gui_optionsPeakMeasurement_OutputFcn(hObject, eventdata, handles) 
