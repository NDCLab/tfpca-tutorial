...
% Specifies the name of the dataset.
  DatasetDef.dataset_name = ['Flanker_stim_ISFA_AMPL_theta_' ... 
                            ];
...
% After dataset is extracted, additional steps that modify the overall dataset (filtering, electrode or subject removal) are run here.
  DatasetDef.loaddata     = ['Flanker_stim_ISFA_base_loaddata;' ...                                 % Specifies the base_loaddata to find information about the individual subject files.
  ...
  DatasetDef.loadvars     = ['Flanker_stim_ISFA_base_loadvars;' ...                          % Specifies the base_loadvars to load information about catcodes and subsampling.
