function [A,f,t,ef]=alg018m_(pc)
%ALG018M_ Computation of Wigner distributions.
%   [W,F,T,EF] = ALG018M_(PC) computes the Wigner distribution W that results
%   from the parameter list PC (cell-array see WIGNER).
...
if ef; warning('Wigner computation interrupted.'); end
