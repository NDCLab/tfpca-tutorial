function [T,ef]=alg006m_(T,timer,monhan,units)
%ALG006M_ FFT computation module (not memory efficient).
%   [F,EF] = ALG006M_(T,TIMER,MONHAN,UNITS) returns the FFT of each column of T in F. TIMER
