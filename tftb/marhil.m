function [A,f,t,ef]=marhil(x,R,varargin)
%MARHIL Computes a discrete Margenau-Hill distribution. 
%   [W,F,T,EF] = MARHIL(X,R,'PropertyName',PropertyValue,...) computes
%   a discrete time Margenau-Hill distribution W from signal X.
...
%   MARHIL displays a job monitor figure. EF contains the return status
...
%
%   See also WIGNER, RUNSPE, and FUTRSP.
...
[A,f,t,ef]=alg017m_(pc,5,' ',mfilename);
