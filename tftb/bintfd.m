function [A,f,t,ef]=bintfd(x,R,varargin)
%BINTFD Computes a discrete time TFD with a binomial kernel. 
%   [W,F,T,EF] = BINTFD(X,R,'PropertyName',PropertyValue,...) computes
%   a discrete time TFD W with binomial kernel-function from signal X.
...
[A,f,t,ef]=alg017m_(pc,1,' ',mfilename);
