function [A,f,t,ef]=runspe(x,R,varargin)
%RUNSPE Computes a discrete running spectrum (Page distribution). 
%   [W,F,T,EF] = RUNSPE(X,R,'PropertyName',PropertyValue,...) computes
%   a discrete running spectrum W (Page distribution) from signal X.
...
%   RUNSPE displays a job monitor figure. EF contains the return status
...
%
%   See also WIGNER, FUTRSP, and MARHIL.
...
[A,f,t,ef]=alg017m_(pc,3,' ',mfilename);
