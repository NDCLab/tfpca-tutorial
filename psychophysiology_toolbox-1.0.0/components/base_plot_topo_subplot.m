...
%         topoplot(z,cur_eloc,'shrink','on','electrodes','off');
        if verbose >= 2,
          eval(['topoplot(z,cur_eloc,''shrink'',''on'',''electrodes'',''on'' ,''emarkersize'',.5,''style'',''straight'',''gridscale'',32' SETvars.electrode_topomapparms '); ']); 
        else,
          evalc(['topoplot(z,cur_eloc,''shrink'',''on'',''electrodes'',''on'' ,''emarkersize'',.5,''style'',''straight'',''gridscale'',32' SETvars.electrode_topomapparms '); ']);
        end
