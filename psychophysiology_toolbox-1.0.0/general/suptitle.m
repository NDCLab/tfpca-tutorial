...
% Edward Bernat 11/15/14 ebernat@umd.eedu -- minor mod to handle structured oldtitle variable 
...
fs = get(gcf,'defaultaxesfontsize');  % +4 no longer required by matlab r2018b, font is large enough - JH 07.17.19
...
if ~isequal(oldtitle,0), % mod to handle structured oldtitle returned by h(i) above EB 11/15/14  
	delete(oldtitle);
end
