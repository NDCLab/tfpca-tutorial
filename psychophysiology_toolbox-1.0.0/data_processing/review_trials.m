function [erp] =  review_trials(erp_inname,outname,electrode_montage,filterspec,AT,verbose,starttrial)
...
% 
% Arguments: 
%   erp_inname, outname, electrode_montage, filterspec, AT, verbose: same as get_components 
% 
%   electrode_mongate, filterspec, and AT: see plot_erpdata 
%
