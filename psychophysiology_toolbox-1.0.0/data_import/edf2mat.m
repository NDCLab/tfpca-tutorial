function [cnt,head,elec,event] = edf2mat(infile,outfile,scale2uV,verbose),
% [edf,head,elec,event] = edf2mat(infile[,outfile][,scale2uV][,verbose])  
% 
...
%                 (unscaled data can be rescaled to uV later using edf2mat_scale2uV)
% 
...
% 
  ...
  if scale2uV==1, 
    [DAT,signal]=readedf(EDF,[1:EDF.Head.NRec]);
  else, 
    [DAT,signal]=readedf(EDF,[1:EDF.Head.NRec],1);
  end 
...
function [DAT,S]=readedf(DAT,Records,Mode)
